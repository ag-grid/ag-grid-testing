...
test.describe("Angular Packages", async () => {
  for (const e of getFrameworkExamples("angular", "packages")) {
...
test.describe("Angular Modules", async () => {
  for (const e of getFrameworkExamples("angular", "modules")) {
    const { examplePath, url } = getExampleConfig(e);
